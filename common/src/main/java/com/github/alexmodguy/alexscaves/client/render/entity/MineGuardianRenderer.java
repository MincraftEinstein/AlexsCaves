...
public class MineGuardianRenderer extends MobRenderer<MineGuardianEntity, MineGuardianModel> {
    private static final ResourceLocation TEXTURE = AlexsCaves.id("textures/entity/mine_guardian.png");
    private static final ResourceLocation TEXTURE_SLEEPING = AlexsCaves.id("textures/entity/mine_guardian_sleeping.png");
    private static final ResourceLocation TEXTURE_EYE = AlexsCaves.id("textures/entity/mine_guardian_eye.png");
    private static final ResourceLocation TEXTURE_EXPLODE = AlexsCaves.id("textures/entity/mine_guardian_explode.png");
