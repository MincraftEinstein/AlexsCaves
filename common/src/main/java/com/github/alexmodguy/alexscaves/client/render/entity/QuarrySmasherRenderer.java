...
public class QuarrySmasherRenderer extends EntityRenderer<QuarrySmasherEntity> {
    ...
    private static final ResourceLocation TEXTURE = AlexsCaves.id("textures/entity/quarry_smasher.png");
    private static final ResourceLocation TEXTURE_GLOW = AlexsCaves.id("textures/entity/quarry_smasher_glow.png");
    private static final ResourceLocation TEXTURE_BOUNDROID = AlexsCaves.id("textures/entity/boundroid_quarry.png");
