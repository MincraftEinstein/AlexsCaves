...
public class ACItemstackRenderer extends BlockEntityWithoutLevelRenderer {
    private static final ResourceLocation GALENA_GAUNTLET_TEXTURE = id("textures/entity/galena_gauntlet.png");
    private static final ResourceLocation GALENA_GAUNTLET_RED_TEXTURE = id("textures/entity/galena_gauntlet_red.png");
    private static final ResourceLocation GALENA_GAUNTLET_BLUE_TEXTURE = id("textures/entity/galena_gauntlet_blue.png");
    ...
    private static final ResourceLocation RESISTOR_SHIELD_TEXTURE = id("textures/entity/resistor_shield.png");
    private static final ResourceLocation RESISTOR_SHIELD_RED_TEXTURE = id("textures/entity/resistor_shield_red.png");
    private static final ResourceLocation RESISTOR_SHIELD_BLUE_TEXTURE = id("textures/entity/resistor_shield_blue.png");
    private static final ResistorShieldModel RESISTOR_SHIELD_MODEL = new ResistorShieldModel();
    private static final ResourceLocation PRIMITIVE_CLUB_TEXTURE = id("textures/entity/primitive_club.png");
    ...
    private static final ResourceLocation RAYGUN_TEXTURE = id("textures/entity/raygun/raygun.png");
    private static final ResourceLocation RAYGUN_ACTIVE_TEXTURE = id("textures/entity/raygun/raygun_active.png");
    private static final ResourceLocation RAYGUN_BLUE_TEXTURE = id("textures/entity/raygun/raygun_blue.png");
    private static final ResourceLocation RAYGUN_BLUE_ACTIVE_TEXTURE = id("textures/entity/raygun/raygun_blue_active.png");
    private static final RaygunModel RAYGUN_MODEL = new RaygunModel();
    private static final ResourceLocation SEA_STAFF_TEXTURE = id("textures/entity/deep_one/sea_staff.png");
    private static final SeaStaffModel SEA_STAFF_MODEL = new SeaStaffModel();
    private static final ResourceLocation ORTHOLANCE_TEXTURE = id("textures/entity/deep_one/ortholance.png");
    private static final OrtholanceModel ORTHOLANCE_MODEL = new OrtholanceModel();
    private static final ResourceLocation COPPER_VALVE_TEXTURE = id("textures/entity/copper_valve.png");
    ...
    private static final ResourceLocation BEHOLDER_TEXTURE = id("textures/entity/beholder.png");
    private static final ResourceLocation BEHOLDER_TEXTURE_EYE = id("textures/entity/beholder_eye.png");
    private static final ResourceLocation DREADBOW_TEXTURE = id("textures/entity/dreadbow.png");
    private static final ResourceLocation DREADBOW_TEXTURE_EYE = id("textures/entity/dreadbow_eye.png");
    private static final ResourceLocation DREADBOW_TEXTURE_EYE_PERFECT = id("textures/entity/dreadbow_eye_perfect.png");
    ...
    private static final ResourceLocation GOBTHUMPER_TEXTURE = id("textures/entity/gobthumper.png");
    private static final ResourceLocation GOBTHUMPER_JELLY_TEXTURE = id("textures/entity/gobthumper_jelly.png");
    private static final ResourceLocation SHOT_GUM_TEXTURE = id("textures/entity/shot_gum.png");
    private static final ResourceLocation SHOT_GUM_GLASS_TEXTURE = id("textures/entity/shot_gum_glass.png");
