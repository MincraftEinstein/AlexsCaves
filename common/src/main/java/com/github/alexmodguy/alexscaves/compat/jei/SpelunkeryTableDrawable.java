...
public class SpelunkeryTableDrawable implements IDrawable {
    ...
    private static final ResourceLocation TEXTURE = AlexsCaves.id("textures/gui/spelunkery_table_jei.png");
    private static final ResourceLocation TEXTURE_WIDGETS = AlexsCaves.id("textures/gui/spelunkery_table_widgets.png");
