...
public class ACBlockRegistry {
    ...
    public static final BlockBehaviour.Properties RADROCK_PROPERTIES = BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).requiresCorrectToolForDrops().strength(4F, 11.0F).sound(ACSoundTypes.RADROCK.get());
    public static final BlockBehaviour.Properties CINDER_BLOCK_PROPERTIES = BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).requiresCorrectToolForDrops().strength(5F, 20.0F).sound(ACSoundTypes.CINDER_BLOCK.get());
    ...
    public static final BlockBehaviour.Properties PEERING_COPROLITH_PROPERTIES = BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_ORANGE).requiresCorrectToolForDrops().strength(1.75F, 4.0F).sound(ACSoundTypes.PEERING_COPROLITH.get()).noOcclusion();
    ...
    public static final BlockBehaviour.Properties CHOCOLATE_PROPERTIES = BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BROWN).strength(1.0F, 2.0F).sound(ACSoundTypes.DENSE_CANDY.get()).instrument(NoteBlockInstrument.BASEDRUM);
    public static final BlockBehaviour.Properties COOKIE_PROPERTIES = BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.5F, 1.5F).sound(ACSoundTypes.DENSE_CANDY.get()).instrument(NoteBlockInstrument.BASEDRUM);
    ...
    public static final BlockBehaviour.Properties GINGERBREAD_PROPERTIES = BlockBehaviour.Properties.of().mapColor(MapColor.DIRT).strength(1.0F, 1.5F).sound(ACSoundTypes.DENSE_CANDY.get()).instrument(NoteBlockInstrument.BASS);
    ...
    public static final Supplier<Block> GALENA_IRON_ORE = registerBlockAndItem("galena_iron_ore", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_ORE).sound(SoundType.DEEPSLATE)));
    ...
    public static final Supplier<Block> AMBER = registerBlockAndItem("amber", () -> new TransparentBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).noOcclusion().requiresCorrectToolForDrops().strength(0.3F, 2.0F).sound(ACSoundTypes.AMBER)));
    ...
    public static final Supplier<Block> SUBTERRANODON_EGG = registerBlockAndItem("subterranodon_egg", () -> new MultipleDinosaurEggsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.5F).sound(SoundType.METAL).randomTicks(), (DeferredHolder) ACEntityRegistry.SUBTERRANODON, 4));
    public static final Supplier<Block> VALLUMRAPTOR_EGG = registerBlockAndItem("vallumraptor_egg", () -> new MultipleDinosaurEggsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.5F).sound(SoundType.METAL).randomTicks(), (DeferredHolder) ACEntityRegistry.VALLUMRAPTOR, 4));
    public static final Supplier<Block> GROTTOCERATOPS_EGG = registerBlockAndItem("grottoceratops_egg", () -> new DinosaurEggBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.5F).sound(SoundType.METAL).randomTicks(), (DeferredHolder) ACEntityRegistry.GROTTOCERATOPS, 8, 10));
    public static final Supplier<Block> TREMORSAURUS_EGG = registerBlockAndItem("tremorsaurus_egg", () -> new DinosaurEggBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.5F).sound(SoundType.METAL).randomTicks(), (DeferredHolder) ACEntityRegistry.TREMORSAURUS, 10, 16));
    public static final Supplier<Block> RELICHEIRUS_EGG = registerBlockAndItem("relicheirus_egg", () -> new DinosaurEggBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.5F).sound(SoundType.METAL).randomTicks(), (DeferredHolder) ACEntityRegistry.RELICHEIRUS, 14, 16));
    public static final Supplier<Block> ATLATITAN_EGG = registerBlockAndItem("atlatitan_egg", () -> new DinosaurEggBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.5F).sound(SoundType.METAL).randomTicks(), (DeferredHolder) ACEntityRegistry.ATLATITAN, 16, 16));
    ...
    public static final Supplier<Block> PEWEN_SIGN = register("pewen_sign", () -> new StandingSignBlock(PEWEN_WOOD_TYPE, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).noCollission().strength(1.0F).sound(SoundType.CHERRY_WOOD)));
    public static final Supplier<Block> PEWEN_WALL_SIGN = register("pewen_wall_sign", () -> new WallSignBlock(PEWEN_WOOD_TYPE, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).noCollission().strength(1.0F).sound(SoundType.CHERRY_WOOD)));
    public static final Supplier<Block> PEWEN_HANGING_SIGN = register("pewen_hanging_sign", () -> new CeilingHangingSignBlock(PEWEN_WOOD_TYPE, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).forceSolidOn().instrument(NoteBlockInstrument.BASS).noCollission().strength(1.0F)));
    public static final Supplier<Block> PEWEN_WALL_HANGING_SIGN = register("pewen_wall_hanging_sign", () -> new WallHangingSignBlock(PEWEN_WOOD_TYPE, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).forceSolidOn().instrument(NoteBlockInstrument.BASS).noCollission().strength(1.0F).dropsLike(PEWEN_HANGING_SIGN.get())));
    public static final Supplier<Block> PEWEN_PRESSURE_PLATE = registerBlockAndItem("pewen_pressure_plate", () -> new PressurePlateBlock(BlockSetType.CHERRY, BlockBehaviour.Properties.ofFullCopy(PEWEN_PLANKS.get()).noCollission().strength(0.5F).sound(SoundType.CHERRY_WOOD)));
    public static final Supplier<Block> PEWEN_TRAPDOOR = registerBlockAndItem("pewen_trapdoor", () -> new TrapDoorBlock(BlockSetType.CHERRY, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(3.0F).sound(SoundType.CHERRY_WOOD).noOcclusion()));
    public static final Supplier<Block> PEWEN_BUTTON = registerBlockAndItem("pewen_button", () -> new ButtonBlock(BlockSetType.CHERRY, 30, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).noCollission().strength(0.5F).sound(SoundType.CHERRY_WOOD)));
    ...
    public static final Supplier<Block> POTTED_PEWEN_PINES = register("potted_pewen_pines", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, PEWEN_PINES, BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final Supplier<Block> PEWEN_SAPLING = registerBlockAndItem("pewen_sapling", () -> new SaplingBlock(PewenGrower.GROWER, BlockBehaviour.Properties.of().mapColor(MapColor.GRASS).noCollission().randomTicks().instabreak().sound(SoundType.GRASS)));
    public static final Supplier<Block> POTTED_PEWEN_SAPLING = register("potted_pewen_sapling", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, PEWEN_SAPLING, BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final Supplier<Block> FIDDLEHEAD = registerBlockAndItem("fiddlehead", () -> new FiddleheadBlock());
    public static final Supplier<Block> POTTED_FIDDLEHEAD = register("potted_fiddlehead", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, FIDDLEHEAD, BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static final Supplier<Block> POTTED_CURLY_FERN = register("potted_curly_fern", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, CURLY_FERN, BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static final Supplier<Block> POTTED_CYCAD = register("potted_cycad", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, CYCAD, BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static final Supplier<Block> ANCIENT_SAPLING = registerBlockAndItem("ancient_sapling", () -> new AncientSaplingBlock(AncientTreeGrower.GROWER, BlockBehaviour.Properties.of().mapColor(MapColor.GRASS).noCollission().randomTicks().instabreak().sound(SoundType.GRASS)));
    public static final Supplier<Block> POTTED_ANCIENT_SAPLING = register("potted_ancient_sapling", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, ANCIENT_SAPLING, BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static final Supplier<Block> FISSURE_PRIMAL_MAGMA = register("fissure_primal_magma", () -> new FissurePrimalMagmaBlock());
    ...
    public static final Supplier<Block> POTTED_UNDERWEED = register("potted_underweed", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, UNDERWEED, BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static final Supplier<Block> NUCLEAR_FURNACE = register("nuclear_furnace", () -> new NuclearFurnaceBlock());
    ...
    public static final Supplier<Block> BIOLUMINESCENT_TORCH = register("bioluminescent_torch", () -> new BioluminescentTorch());
    public static final Supplier<Block> BIOLUMINESCENT_WALL_TORCH = register("bioluminescent_wall_torch", () -> new BioluminescentWallTorch());
    ...
    public static final Supplier<Block> GUANOSTONE_REDSTONE_ORE = registerBlockAndItem("guanostone_redstone_ore", () -> new RedStoneOreBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.REDSTONE_ORE).sound(SoundType.BASALT)));
    ...
    public static final Supplier<Block> COPROLITH_COAL_ORE = registerBlockAndItem("coprolith_coal_ore", () -> new DropExperienceBlock(UniformInt.of(0, 2), BlockBehaviour.Properties.ofFullCopy(Blocks.COAL_ORE).sound(SoundType.CALCITE)));
    ...
    public static final Supplier<Block> POTTED_THORNWOOD_BRANCH = register("potted_thornwood_branch", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, THORNWOOD_BRANCH, BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static final Supplier<Block> THORNWOOD_SIGN = register("thornwood_sign", () -> new StandingSignBlock(THORNWOOD_WOOD_TYPE, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).noCollission().strength(1.0F).sound(SoundType.WOOD)));
    public static final Supplier<Block> THORNWOOD_WALL_SIGN = register("thornwood_wall_sign", () -> new WallSignBlock(THORNWOOD_WOOD_TYPE, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).noCollission().strength(1.0F).sound(SoundType.WOOD)));
    public static final Supplier<Block> THORNWOOD_HANGING_SIGN = register("thornwood_hanging_sign", () -> new CeilingHangingSignBlock(THORNWOOD_WOOD_TYPE, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).forceSolidOn().instrument(NoteBlockInstrument.BASS).noCollission().strength(1.0F)));
    public static final Supplier<Block> THORNWOOD_WALL_HANGING_SIGN = register("thornwood_wall_hanging_sign", () -> new WallHangingSignBlock(THORNWOOD_WOOD_TYPE, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).forceSolidOn().instrument(NoteBlockInstrument.BASS).noCollission().strength(1.0F).dropsLike(THORNWOOD_HANGING_SIGN.get())));
    public static final Supplier<Block> THORNWOOD_PRESSURE_PLATE = registerBlockAndItem("thornwood_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(THORNWOOD_PLANKS.get()).noCollission().strength(0.5F).sound(SoundType.WOOD)));
    public static final Supplier<Block> THORNWOOD_TRAPDOOR = registerBlockAndItem("thornwood_trapdoor", () -> new TrapDoorBlock(BlockSetType.OAK, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).strength(3.0F).sound(SoundType.WOOD).noOcclusion()));
    ...
    public static final Supplier<Block> THORNWOOD_FENCE_GATE = registerBlockAndItem("thornwood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(THORNWOOD_PLANKS.get()).strength(2.0F, 3.0F).sound(SoundType.WOOD).forceSolidOn(), SoundEvents.FENCE_GATE_CLOSE, SoundEvents.FENCE_GATE_OPEN));
    ...
    public static final Supplier<Block> THORNWOOD_SAPLING = registerBlockAndItem("thornwood_sapling", () -> new CaveSaplingBlock(ThornwoodGrower.GROWER, BlockBehaviour.Properties.of().mapColor(MapColor.GRASS).noCollission().randomTicks().instabreak().sound(SoundType.GRASS), true));
    public static final Supplier<Block> POTTED_THORNWOOD_SAPLING = register("potted_thornwood_sapling", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, THORNWOOD_SAPLING, BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static void init() {
        registerPot(FLYTRAP, POTTED_FLYTRAP);
        registerPot(CURLY_FERN, POTTED_CURLY_FERN);
        registerPot(CYCAD, POTTED_CYCAD);
        registerPot(PEWEN_SAPLING, POTTED_PEWEN_SAPLING);
        registerPot(PEWEN_PINES, POTTED_PEWEN_PINES);
        registerPot(FIDDLEHEAD, POTTED_FIDDLEHEAD);
        registerPot(ANCIENT_SAPLING, POTTED_ANCIENT_SAPLING);
        registerPot(UNDERWEED, POTTED_UNDERWEED);
        registerPot(THORNWOOD_BRANCH, POTTED_THORNWOOD_BRANCH);
    ...
    private static Supplier<? extends BlockItemWithSupplier> getBlockSupplier(int itemType, Supplier<Block> block) {
        return switch (itemType) {
            ...
            case 8 ->
                    () -> new BlockItemWithSupplier(block, new Item.Properties().rarity(Rarity.UNCOMMON).fireResistant().rarity(ACItemRegistry.getRarityNuclear()));
