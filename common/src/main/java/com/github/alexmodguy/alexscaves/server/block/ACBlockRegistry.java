...
public class ACBlockRegistry {
    ...
    public static final Supplier<Block> METAL_SWARF = registerBlockAndItem("metal_swarf", () -> new FallingBlockWithColor(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(0.6F).sound(ACSoundTypes.METAL_SWARF.get()), 0X404253));
    public static final Supplier<Block> SCRAP_METAL = registerBlockAndItem("scrap_metal", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).requiresCorrectToolForDrops().strength(5F, 15.0F).sound(ACSoundTypes.SCRAP_METAL.get())));
    public static final Supplier<Block> SCRAP_METAL_PLATE = registerBlockAndItem("scrap_metal_plate", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).requiresCorrectToolForDrops().strength(5F, 15.0F).sound(ACSoundTypes.SCRAP_METAL.get())));
    ...
    public static final Supplier<Block> AMBER = registerBlockAndItem("amber", () -> new TransparentBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).noOcclusion().requiresCorrectToolForDrops().strength(0.3F, 2.0F).sound(ACSoundTypes.AMBER.get())));
    ...
    public static final Supplier<Block> FLOOD_BASALT = registerBlockAndItem("flood_basalt", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_RED).strength(3.0F, 100.0F).sound(ACSoundTypes.FLOOD_BASALT.get()).requiresCorrectToolForDrops()));
...
//    public static final Supplier<Block> ACID = register("acid", () -> new AcidBlock(ACFluidRegistry.ACID_FLUID_SOURCE, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).noCollission().strength(100.0F).lightLevel(state -> 7).emissiveRendering((state, world, pos) -> false).noLootTable().replaceable().liquid().pushReaction(PushReaction.DESTROY)));
    ...
    public static final Supplier<Block> RUSTY_SCRAP_METAL_PLATE = registerBlockAndItem("rusty_scrap_metal_plate", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BROWN).requiresCorrectToolForDrops().strength(5F, 15.0F).sound(ACSoundTypes.SCRAP_METAL.get())));
    ...
    public static final Supplier<Block> BLOCK_OF_FROSTING = registerBlockAndItemEdible("block_of_frosting", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PINK).strength(1.0F, 1.0F).sound(ACSoundTypes.SQUISHY_CANDY.get()).instrument(NoteBlockInstrument.BASEDRUM)), ACFoods.BLOCK_OF_FROSTING);
    public static final Supplier<Block> BLOCK_OF_VANILLA_FROSTING = registerBlockAndItemEdible("block_of_vanilla_frosting", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(1.0F, 1.0F).sound(ACSoundTypes.SQUISHY_CANDY.get()).instrument(NoteBlockInstrument.BASEDRUM)), ACFoods.BLOCK_OF_FROSTING);
    public static final Supplier<Block> BLOCK_OF_CHOCOLATE_FROSTING = registerBlockAndItemEdible("block_of_chocolate_frosting", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BROWN).strength(1.0F, 1.0F).sound(ACSoundTypes.SQUISHY_CANDY.get()).instrument(NoteBlockInstrument.BASEDRUM)), ACFoods.BLOCK_OF_FROSTING);
    ...
    public static final Supplier<Block> CAKE_LAYER = registerBlockAndItemEdible("cake_layer", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.DIRT).strength(1.5F, 1.0F).sound(ACSoundTypes.SOFT_CANDY.get()).instrument(NoteBlockInstrument.BASEDRUM)), ACFoods.CAKE_LAYER);
