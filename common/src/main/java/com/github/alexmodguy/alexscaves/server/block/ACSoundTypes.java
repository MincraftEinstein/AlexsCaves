...
public class ACSoundTypes {
    ...
    public static final Supplier<SoundType> RADROCK = register(() -> new SoundType(1, 1, ACSoundRegistry.RADROCK_BREAK.get(), ACSoundRegistry.RADROCK_STEP.get(), ACSoundRegistry.RADROCK_PLACE.get(), ACSoundRegistry.RADROCK_BREAKING.get(), ACSoundRegistry.RADROCK_STEP.get()));
    ...
    public static final Supplier<SoundType> CINDER_BLOCK = register(() -> new SoundType(1, 1, ACSoundRegistry.CINDER_BLOCK_BREAK.get(), ACSoundRegistry.CINDER_BLOCK_STEP.get(), ACSoundRegistry.CINDER_BLOCK_PLACE.get(), ACSoundRegistry.CINDER_BLOCK_BREAKING.get(), ACSoundRegistry.CINDER_BLOCK_STEP.get()));
    ...
    public static final Supplier<SoundType> PEERING_COPROLITH = register(() -> new SoundType(1, 1, ACSoundRegistry.PEERING_COPROLITH_BREAK.get(), ACSoundRegistry.PEERING_COPROLITH_STEP.get(), ACSoundRegistry.PEERING_COPROLITH_PLACE.get(), ACSoundRegistry.PEERING_COPROLITH_BREAKING.get(), ACSoundRegistry.PEERING_COPROLITH_STEP.get()));
    ...
    public static final Supplier<SoundType> DENSE_CANDY = register(() -> new SoundType(1, 1, ACSoundRegistry.DENSE_CANDY_BREAK.get(), ACSoundRegistry.DENSE_CANDY_STEP.get(), ACSoundRegistry.DENSE_CANDY_PLACE.get(), ACSoundRegistry.DENSE_CANDY_BREAKING.get(), ACSoundRegistry.DENSE_CANDY_STEP.get()));
