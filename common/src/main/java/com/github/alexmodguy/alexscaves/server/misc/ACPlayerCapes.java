...
public class ACPlayerCapes {
    ...
    private static final ResourceLocation DEVELOPER_CAPE_TEXTURE = AlexsCaves.id("textures/entity/cape/developer.png");
    private static final ResourceLocation CONTRIBUTOR_CAPE_TEXTURE = AlexsCaves.id("textures/entity/cape/contributor.png");
