...
public class RainbowParticle extends Particle {
    ...
    private static final RenderType RAINBOW_RENDER_TYPE = ACRenderTypes.getRainbow(ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/particle/rainbow.png"));
