...
public class VoidBeingTendrilParticle extends Particle {
    ...
    private static final ResourceLocation TENDRIL_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/particle/void_being_cloud_tendril.png");
