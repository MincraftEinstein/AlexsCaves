...
public class NuclearFurnaceBlockRenderer<T extends NuclearFurnaceBlockEntity> implements BlockEntityRenderer<T> {
    ...
    private static final ResourceLocation OFF_TEXTURE = AlexsCaves.id("textures/entity/nuclear_furnace/nuclear_furnace_off.png");
    private static final ResourceLocation ON_TEXTURE = AlexsCaves.id("textures/entity/nuclear_furnace/nuclear_furnace_on.png");
    private static final ResourceLocation SUBCRITICAL_TEXTURE = AlexsCaves.id("textures/entity/nuclear_furnace/nuclear_furnace_subcritical.png");
    private static final ResourceLocation CRITICAL_TEXTURE = AlexsCaves.id("textures/entity/nuclear_furnace/nuclear_furnace_critical.png");
    private static final ResourceLocation SUPERCRITICAL_TEXTURE = AlexsCaves.id("textures/entity/nuclear_furnace/nuclear_furnace_supercritical.png");

    private static final ResourceLocation OFF_TEXTURE_GLOW = AlexsCaves.id("textures/entity/nuclear_furnace/nuclear_furnace_off_glow.png");
    private static final ResourceLocation ON_TEXTURE_GLOW = AlexsCaves.id("textures/entity/nuclear_furnace/nuclear_furnace_on_glow.png");
    private static final ResourceLocation SUBCRITICAL_TEXTURE_GLOW = AlexsCaves.id("textures/entity/nuclear_furnace/nuclear_furnace_subcritical_glow.png");
    private static final ResourceLocation CRITICAL_TEXTURE_GLOW = AlexsCaves.id("textures/entity/nuclear_furnace/nuclear_furnace_critical_glow.png");
    private static final ResourceLocation SUPERCRITICAL_TEXTURE_GLOW = AlexsCaves.id("textures/entity/nuclear_furnace/nuclear_furnace_supercritical_glow.png");
