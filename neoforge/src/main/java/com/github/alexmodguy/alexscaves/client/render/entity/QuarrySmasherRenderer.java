...
public class QuarrySmasherRenderer extends EntityRenderer<QuarrySmasherEntity> {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/quarry_smasher.png");
    private static final ResourceLocation TEXTURE_GLOW = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/quarry_smasher_glow.png");
    private static final ResourceLocation TEXTURE_BOUNDROID = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/boundroid_quarry.png");
