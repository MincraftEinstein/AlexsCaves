...
public class TremorzillaRenderer extends MobRenderer<TremorzillaEntity, TremorzillaModel> implements CustomBookEntityRenderer {
    ...
    private static final ResourceLocation TEXTURE_GLOW = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_glow.png");
    private static final ResourceLocation TEXTURE_RETRO_GLOW = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_retro_glow.png");
    private static final ResourceLocation TEXTURE_TECTONIC_GLOW = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_tectonic_glow.png");
    private static final ResourceLocation TEXTURE_GLOW_POWERED = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_glow_powered.png");
    private static final ResourceLocation TEXTURE_RETRO_GLOW_POWERED = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_retro_glow_powered.png");
    private static final ResourceLocation TEXTURE_TECTONIC_GLOW_POWERED = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_tectonic_glow_powered.png");
    private static final ResourceLocation TEXTURE_BEAM_INNER = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_beam_inner.png");
    private static final ResourceLocation TEXTURE_RETRO_BEAM_INNER = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_retro_beam_inner.png");
    private static final ResourceLocation TEXTURE_TECTONIC_BEAM_INNER = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_tectonic_beam_inner.png");
    private static final ResourceLocation TEXTURE_BEAM_OUTER = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_beam_outer.png");
    private static final ResourceLocation TEXTURE_RETRO_BEAM_OUTER = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_retro_beam_outer.png");
    private static final ResourceLocation TEXTURE_TECTONIC_BEAM_OUTER = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_tectonic_beam_outer.png");
    private static final ResourceLocation TEXTURE_BEAM_END_0 = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_beam_end_0.png");
    private static final ResourceLocation TEXTURE_RETRO_BEAM_END_0 = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_retro_beam_end_0.png");
    private static final ResourceLocation TEXTURE_TECTONIC_BEAM_END_0 = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_tectonic_beam_end_0.png");
    private static final ResourceLocation TEXTURE_BEAM_END_1 = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_beam_end_1.png");
    private static final ResourceLocation TEXTURE_RETRO_BEAM_END_1 = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_retro_beam_end_1.png");
    private static final ResourceLocation TEXTURE_TECTONIC_BEAM_END_1 = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_tectonic_beam_end_1.png");
    private static final ResourceLocation TEXTURE_BEAM_END_2 = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_beam_end_2.png");
    private static final ResourceLocation TEXTURE_RETRO_BEAM_END_2 = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_retro_beam_end_2.png");
    private static final ResourceLocation TEXTURE_TECTONIC_BEAM_END_2 = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/tremorzilla/tremorzilla_tectonic_beam_end_2.png");
    ...
    public void render(TremorzillaEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource source, int packedLight) {
        ...
        if (beamProgress > 0.0F && entity.isAlive() && beamEndVec != null) {
            ...
            if(AlexsCavesNeoForge.CLIENT_CONFIG.radiationGlowEffect.get()){
    ...
    private void renderBeam(TremorzillaEntity entity, PoseStack poseStack, MultiBufferSource source, float partialTicks, float width, float length, boolean inner, boolean glowSecondPass) {
        ...
        if (inner) {
            ...
            if (AlexsCavesNeoForge.CLIENT_CONFIG.radiationGlowEffect.get() && glowSecondPass) {
    ...
    class LayerGlow extends RenderLayer<TremorzillaEntity, TremorzillaModel> {
        ...
        public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, TremorzillaEntity tremorzilla, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            this.getParentModel().renderToBuffer(matrixStackIn, normalGlowConsumer, packedLightIn, LivingEntityRenderer.getOverlayCoords(tremorzilla, 0.0F), ColorUtil.packColor(1.0F, 1.0F, 1.0F, normalAlpha));
            if (spikeDownAmount > 0) {
                ...
                this.getParentModel().renderToBuffer(matrixStackIn, spikeGlowConsumer, packedLightIn, LivingEntityRenderer.getOverlayCoords(tremorzilla, 0.0F), -1);
