...
public class ACItemstackRenderer extends BlockEntityWithoutLevelRenderer {
    private static final ResourceLocation GALENA_GAUNTLET_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/galena_gauntlet.png");
    private static final ResourceLocation GALENA_GAUNTLET_RED_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/galena_gauntlet_red.png");
    private static final ResourceLocation GALENA_GAUNTLET_BLUE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/galena_gauntlet_blue.png");
    ...
    private static final ResourceLocation RESISTOR_SHIELD_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/resistor_shield.png");
    private static final ResourceLocation RESISTOR_SHIELD_RED_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/resistor_shield_red.png");
    private static final ResourceLocation RESISTOR_SHIELD_BLUE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/resistor_shield_blue.png");
    private static final ResistorShieldModel RESISTOR_SHIELD_MODEL = new ResistorShieldModel();
    private static final ResourceLocation PRIMITIVE_CLUB_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/primitive_club.png");
    private static final PrimitiveClubModel PRIMITIVE_CLUB_MODEL = new PrimitiveClubModel();
    private static final ResourceLocation LIMESTONE_SPEAR_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/limestone_spear.png");
    private static final LimestoneSpearModel LIMESTONE_SPEAR_MODEL = new LimestoneSpearModel();
    private static final ResourceLocation EXTINCTION_SPEAR_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/extinction_spear.png");
    private static final ExtinctionSpearModel EXTINCTION_SPEAR_MODEL = new ExtinctionSpearModel();
    private static final ResourceLocation SIREN_LIGHT_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/siren_light.png");
    private static final ResourceLocation SIREN_LIGHT_COLOR_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/siren_light_color.png");
    private static final SirenLightModel SIREN_LIGHT_MODEL = new SirenLightModel();
    private static final ResourceLocation RAYGUN_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/raygun/raygun.png");
    private static final ResourceLocation RAYGUN_ACTIVE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/raygun/raygun_active.png");
    private static final ResourceLocation RAYGUN_BLUE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/raygun/raygun_blue.png");
    private static final ResourceLocation RAYGUN_BLUE_ACTIVE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/raygun/raygun_blue_active.png");
    private static final RaygunModel RAYGUN_MODEL = new RaygunModel();
    private static final ResourceLocation SEA_STAFF_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/deep_one/sea_staff.png");
    private static final SeaStaffModel SEA_STAFF_MODEL = new SeaStaffModel();
    private static final ResourceLocation ORTHOLANCE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/deep_one/ortholance.png");
    private static final OrtholanceModel ORTHOLANCE_MODEL = new OrtholanceModel();
    private static final ResourceLocation COPPER_VALVE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/copper_valve.png");
    ...
    private static final ResourceLocation BEHOLDER_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/beholder.png");
    private static final ResourceLocation BEHOLDER_TEXTURE_EYE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/beholder_eye.png");
    private static final ResourceLocation DREADBOW_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/dreadbow.png");
    private static final ResourceLocation DREADBOW_TEXTURE_EYE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/dreadbow_eye.png");
    private static final ResourceLocation DREADBOW_TEXTURE_EYE_PERFECT = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/dreadbow_eye_perfect.png");
    ...
    private static final ResourceLocation GOBTHUMPER_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/gobthumper.png");
    private static final ResourceLocation GOBTHUMPER_JELLY_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/gobthumper_jelly.png");
    private static final ResourceLocation SHOT_GUM_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/shot_gum.png");
    private static final ResourceLocation SHOT_GUM_GLASS_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/shot_gum_glass.png");
    private static final ShotGumModel SHOT_GUM_MODEL = new ShotGumModel();
    private static final ResourceLocation SUGAR_STAFF_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/sugar_staff.png");
    private static final SugarStaffModel SUGAR_STAFF_MODEL = new SugarStaffModel();
    private static final ResourceLocation FROSTMINT_SPEAR_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/entity/frostmint_spear.png");
