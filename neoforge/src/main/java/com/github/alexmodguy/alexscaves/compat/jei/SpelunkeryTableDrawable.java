...
public class SpelunkeryTableDrawable implements IDrawable {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/gui/spelunkery_table_jei.png");
    private static final ResourceLocation TEXTURE_WIDGETS = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "textures/gui/spelunkery_table_widgets.png");
