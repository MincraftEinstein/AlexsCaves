...
public class ACBiomeRarity {
    ...
    public static void init() {
        VORONOI_GENERATOR.setOffsetAmount(AlexsCavesNeoForge.COMMON_CONFIG.caveBiomeSpacingRandomness.get());
        biomeSize = AlexsCavesNeoForge.COMMON_CONFIG.caveBiomeMeanWidth.get() * 0.25D;
        seperationDistance = biomeSize + AlexsCavesNeoForge.COMMON_CONFIG.caveBiomeMeanSeparation.get() * 0.25D;
    }
    ...
    public static VoronoiGenerator.VoronoiInfo getRareBiomeInfoForQuad(long worldSeed, int x, int z) {
        ...
        double positionOffsetX = AlexsCavesNeoForge.COMMON_CONFIG.caveBiomeWidthRandomness.get() * NOISE_X.getValue(sampleX, sampleZ, false);
        double positionOffsetZ = AlexsCavesNeoForge.COMMON_CONFIG.caveBiomeWidthRandomness.get() * NOISE_Z.getValue(sampleX, sampleZ, false);
