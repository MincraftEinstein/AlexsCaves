...
public class ACLootTableRegistry {
    ...
    public static final ResourceKey<LootTable> ABYSSAL_RUINS_CHEST = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "chests/abyssal_ruins"));
    public static final ResourceKey<LootTable> WITCH_HUT_CHEST = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "chests/witch_hut"));
    public static final ResourceKey<LootTable> LICOWITCH_TOWER_CHEST = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "chests/licowitch_tower"));
    public static final ResourceKey<LootTable> SECRET_LICOWITCH_TOWER_CHEST = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "chests/licowitch_tower_secret"));
    public static final ResourceKey<LootTable> GINGERBREAD_TOWN_CHEST = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(AlexsCaves.MOD_ID, "chests/gingerbread_town"));
